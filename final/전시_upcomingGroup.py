...
# myDF['content'] = myDF['content'].apply(lambda x: re.sub(r'[\r\n]+', '', x[0]) if isinstance(x, list) else x).apply(cleaned)
#
...
print(myDF.head(2))
# myDF.to_csv('wth2.csv',index=False, encoding='utf-8-sig')
# print(myDF)
